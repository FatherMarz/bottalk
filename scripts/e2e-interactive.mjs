...
const caller = child("caller.json", ["call", "stream test", "--from", "Marcello"]);
...
ok(callee.buf.includes("Marcello") && callee.buf.includes("stream test"), "callee sees intro before approving");
